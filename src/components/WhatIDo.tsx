        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Transforming datasets into clear business insights with dashboards,
                visualizations, and statistical analysis to support decision-making.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>AUTOMATION</h3>
              <h4>ETL & data cleaning</h4>
              <p>
                Automating data pipelines and cleaning workflows to reduce manual
                processing and deliver consistent, reliable datasets.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
